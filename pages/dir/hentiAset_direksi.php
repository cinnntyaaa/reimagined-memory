                ...
                <div class="col-12">
                    <div class="card">
                        <div class="card-body">
                            ...
                            <hr data-content="MEMO PENGHENTIAN ASSET BELUM DIACC" class="hr-text">
                                        ...
                                        if (mysqli_multi_query($conn, $sql)) {
                                            ...
                                            foreach ($outp[0] as $data) {
                                                ...
                                                <tr>
                                                    ...
                                                    <td class='align-middle'>$data[tgl_beli]</td>
                                                    <td class='text-right align-middle'>" . rupiah($data['harga_beli']) . "</td>
                                                    <td class='text-right align-middle'>" . rupiah($data['nilai']) . "</td>
                                                    <td class='text-center align-middle'><button class='btn bg-transparent' onclick=view($data[ASET_ID])><img width='30px' height='30px' src='../../assets/svg/view.svg'></button></td>
                                                </tr> ";
                                                $no++;
                                            }
                                        }
                            ...
                            <div class="table-responsive">
                            <hr data-content="MEMO PENGHENTIAN ASSET TELAH DIACC" class="hr-text">
                                <table class="table table-bordered table-md h6">
                                    <thead>
                                        <tr>
                                            <th>NO</th>
...
<script>
    function view(asetid) {
        ...
        document.getElementById("submit").onclick = (function() {
            ...
            var ket = $("#ket").val();
            $.ajax({
                url: 'createDispoHenti_direksi.php',
                type: 'POST',
                data: {
                    asetid: asetid,
                    user_id: user_id,
