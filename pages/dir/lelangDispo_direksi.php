                    ...
                    <div class="card">
                        <div class="card-body">
                            <div class="table-responsive">
                                <hr data-content="MEMO LELANG BELUM DIACC" class="hr-text">
                            ...
                            <div class="table-responsive">
                                <hr data-content="MEMO LELANG TELAH DIACC" class="hr-text">
                                <table class="table table-bordered table-md h6">
                                    <thead>
                                        <tr>
                                            <th>NO</th>
...
<script>
    function view(asetid) {
        ...
        document.getElementById("submit").onclick = (function() {
            ...
            var ket = $("#ket").val();
            $.ajax({
                url: 'createDispoLelang_direksi.php',
                type: 'POST',
                data: {
                    asetid: asetid,
                    user_id: user_id,
