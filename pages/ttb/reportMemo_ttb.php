        ...
        <div class="section-body">
            <div class="row">
                <div class="col-12">
                    <div class="card">
                        <div class="card-body">
                            <form method="post" action="reportMemo_ttb.php" class="form-inline mb-3">
                                ...
                                <table class="table table-bordered table-md h6">
                                    ...
                                    <tbody>
                                        ...
                                        if (isset($_POST['submit'])) {
                                            ...
                                            $submit = $_POST['submit'];
                                            $dirUpload = "../../file/";
                                            $sql = "CALL reportMemo_ttb ('" . $tgl_awal . "', '" . $tgl_akhir . "')";
                                            $query = mysqli_query($conn, $sql);
                                            while ($data = mysqli_fetch_array($query)) {
                                                if ($data['attach_rekom'] == "") {
                                                    $attach = "-";
                                                } else {
                                                    $attach = "<a target='_blank' href='" . $dirUpload . $data['attach_rekom'] . "'>'File Lampiran Rekom'</a>";
                                                }
                                                if ($data['STATUS'] == 0) {
                                                ...
                                                <tr class='child-" . $no . "' style='display: none;'>
                                                    ...
                                                    <tr class='child-" . $no . "' style='display: none;'>
                                                        <td>Biaya Rekom :</td>
                                                        <td colspan=5>" . rupiah($data['biaya_rekom']) . "</td>
                                                    </tr>
                                                    <tr class='child-" . $no . "' style='display: none;'>
                                                        <td>Disposisi :</td>
